...
* 2024.06<span style="padding-left: 150px;"></span> 정보처리기사
* 2023.12<span style="padding-left: 150px;"></span> 네트워크관리 2급
* 2023.06<span style="padding-left: 150px;"></span> 산업안전산업기사
* 2021.06<span style="padding-left: 150px;"></span> 기계설계산업기사

### Education
* 2020.02<span style="padding-left: 150px;"></span>경남정보대학교  
  <span style="padding-left: 205px;"></span>전자과
* 2024.07<span style="padding-left: 150px;"></span>부산IT아카데미  
  <span style="padding-left: 205px;"></span> (스마트웹&콘텐츠개발)자바웹 콘텐츠개발
...
### 회원가입
- 일반 회원가입은 Spring Security를 사용하여 사용자 정보를 저장하였습니다.

### 로그인, 소셜로그인, 로그아웃
- 소셜 로그인은 OAuth2 방식을 통해 인증하며, JWT를 사용하여 인증 토큰을 관리합니다.
...
3. 로컬 스토리지에 엑세스토큰 저장
   <img class="selfie" alt="이병훈" src="/assets/img/OAuth2.png" />
...
### 🖥️ 프로젝트 소개(CinemaCast)
영화관 사이트를 참고하여 "cinema"와 "broadcast"의 결합으로 영화 정보와 편리한 예매 기능을 제공하는 웹 애플리케이션을 개발하였습니다.

#### 🔗 GitHub 주소<span style="padding-left: 120px;"></span> 📄 프로젝트 발표 자료
[프로젝트 GitHub 저장소](https://github.com/qudgns8883/CINEMACAST)<span style="padding-left: 80px;"></span>- 발표 자료는 [여기에서 다운로드할 수 있습니다](https://docs.google.com/presentation/d/1Ua3kVJtuOFLrB7LKAKkkmn6AiUeTZ_L_/edit?usp=drive_link&ouid=104385299162078736648&rtpof=true&sd=true).

#### 👨‍👩‍👦 프로젝트 구성원
- **팀원1**:  회원가입, 로그인, 관리자, 결제 페이지 개발
- **팀원2**:  기획서 작성, 퍼블리싱, 좌석 선택 및 상영시간표 구현
- **팀원3**:  TMDB.API를 이용한 영화 정보 페이지 개발
- **팀원4**: 이병훈 - TMDB.API를 이용한 영화 정보 페이지 및 고객센터 구현

### ⚙️ 사용한 기술
Java, Spring Boot, Spring Security, Spring Data JPA, MySQL, Docker, GitHub Actions
...
### 🛠️ 트러블슈팅 내용
#### 문제 상황
개발 단계에서 메인 페이지에 접근하거나 애플리케이션 재시작할 때 TMDB API에서 데이터를 받아오는 데 16초가 소요되는 문제 발생했습니다. 이로 인해 테스트 사용자 경험이 저하되었고, 팀원에게 피드백을 요청했으나 개선되지 않아 리팩토링을 진행했습니다.
...
2. Redis를 사용한 글로벌 캐시 도입  
   Caffeine의 한계를 해결하기 위해 Rddis를 통해 데이터를 캐싱함으로써 메인페이지 접근 시 및 재시작 시 로딩 시간을 16초에서 2초로 단축하고, 불필요한 쿼리를 줄여 데이터 조회 성능을 향상
...
#### 🔗 GitHub 주소<span style="padding-left: 120px;"></span> 📄 프로젝트 발표 자료
[프로젝트 GitHub 저장소](https://github.com/qudgns8883/okTodo)<span style="padding-left: 80px;"></span>- 발표 자료는 [여기에서 다운로드할 수 있습니다](https://docs.google.com/presentation/d/1KQ-F4DNNuuqudbfg9VAc5JMa-u_E14DF/edit?usp=drive_link&ouid=104385299162078736648&rtpof=true&sd=true).
